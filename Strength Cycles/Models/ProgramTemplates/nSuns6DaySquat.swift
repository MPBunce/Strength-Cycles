...
@Model
class nSunsSixDaySquatProgram: ProgramProtocol {
    ...
    init(benchTM: Double, squatTM: Double, deadliftTM: Double, ohpTM: Double) {
        ...
        self.trainingDays = [
            ...
            // Tuesday: Squat + Sumo Deadlift (formerly Thursday)
            TrainingDay(
                dayIndex: 1,
                ...
                day: [
                    Exercise(
                        ...
                        name: "Squat",
                        canAlterSets: false,
                        sets: createThursdaySquatSets(tm: squatTM)
                    ),
                    Exercise(
                        exerciseIndex: 1,
                        name: "Sumo Deadlift",
                        canAlterSets: false,
                        sets: createThursdaySumoSets(tm: deadliftTM)
                    ),
                    Exercise(
                        exerciseIndex: 2,
            ...
            // Thursday: Deadlift + Front Squat (formerly Tuesday)
            TrainingDay(
                dayIndex: 3,
                ...
                day: [
                    Exercise(
                        ...
                        name: "Deadlift",
                        canAlterSets: false,
                        sets: createTuesdayDeadliftSets(tm: deadliftTM)
                    ),
                    Exercise(
                        exerciseIndex: 1,
                        name: "Front Squat",
                        canAlterSets: false,
                        sets: createTuesdayFrontSquatSets(tm: squatTM)
                    ),
                    Exercise(
                        exerciseIndex: 2,
                        name: "T-Bar Rows",
            ...
            // Saturday: Squat + Front Squat
            TrainingDay(
                dayIndex: 5,
                dayName: "Squat + Front Squat",
                day: [
                    Exercise(
                        exerciseIndex: 0,
                        name: "Squat",
                        canAlterSets: false,
                        sets: createSaturdaySquatSets(tm: squatTM)
                    ),
                    Exercise(
                        exerciseIndex: 1,
                        name: "Sumo Deadlift",
...
// MARK: - Tuesday Sets (Deadlift + Front Squat)

private func createTuesdayDeadliftSets(tm: Double) -> [ExerciseSet] {
...
private func createTuesdayFrontSquatSets(tm: Double) -> [ExerciseSet] {
...
// MARK: - Thursday Sets (Squat + Sumo Deadlift)

private func createThursdaySquatSets(tm: Double) -> [ExerciseSet] {
...
private func createThursdaySumoSets(tm: Double) -> [ExerciseSet] {
...
// MARK: - Saturday Sets (Squat + Front Squat)

private func createSaturdaySquatSets(tm: Double) -> [ExerciseSet] {
    // 85x3, 85x3, 85x3+, 85x3, 85x3, 85x3, 85x3, 85x3
    let percentages = [0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85]
    let reps = [3, 3, 3, 3, 3, 3, 3, 3]
    
    return zip(percentages, reps).enumerated().map { index, data in
        let (percentage, repCount) = data
        let isAmrap = (index == 2) // Third set is AMRAP
        return createExerciseSet(
            setIndex: index,
            reps: repCount,
            weight: tm * percentage,
